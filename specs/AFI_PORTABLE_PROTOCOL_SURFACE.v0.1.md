...
`afi-artifacts`, `afi-benchkit`, `afi-config`, `afi-core`, `afi-docs`, `afi-econ`, `afi-factory`, `afi-gateway`, `afi-governance`, `afi-infra`, `afi-math`, `afi-mint`, `afi-ops`, `afi-protocol`, `afi-reactor`, `afi-research-site`, `afi-tiny-brains`, `afi-token`, `afi-xerc20`
