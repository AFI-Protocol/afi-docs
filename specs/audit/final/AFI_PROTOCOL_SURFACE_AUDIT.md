...
| **Market / analytics** | 1 | No analytics-plane schema anywhere in the canonical library; `rg -nwi -c "bigquery\|kafka\|warehouse\|snowflake\|redshift" afi-config/schemas` → 0 hits. |
